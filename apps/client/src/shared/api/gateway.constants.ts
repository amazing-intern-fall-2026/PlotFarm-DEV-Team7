/**
 * Error messages cho lớp Gateway (network, parse, timeout).
 * Tách khỏi auth error messages để tái dùng cho bất kỳ dispatchAction nào.
 */
...
export const GATEWAY_ENDPOINT = "/api/gateway";
